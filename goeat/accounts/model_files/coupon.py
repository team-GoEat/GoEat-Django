...
class UserCoupon(models.Model):
    ...
    # 쿠폰 만료 시작 날짜
    user_ccoupon_start_dttm = models.DateTimeField(auto_now_add=True,auto_now=False)
    # 쿠폰  만료 종료 날짜
    user_ccoupon_end_dttm = models.DateTimeField(auto_now_add=True,auto_now=False)
    # 쿠폰 발행 날짜
    user_ccoupon_create_dttm = models.DateTimeField(auto_now_add=True,auto_now=False)
