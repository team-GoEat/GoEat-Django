    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menu_point', to='restaurant.menusecondclass')),
            ],
        ),
        migrations.CreateModel(
            name='NonMember',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('menu_cannoteat', models.ManyToManyField(blank=True, to='restaurant.MenuCannotEat')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('res_state', models.CharField(default='승인 대기', max_length=30)),
                ...
                ('res_expect_time', models.DateTimeField(blank=True, null=True)),
                ('res_deadline_time', models.DateTimeField(blank=True, null=True)),
                ('is_active', models.BooleanField(blank=True, default=True)),
